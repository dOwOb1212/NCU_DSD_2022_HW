...
set_property PACKAGE_PIN H1 [get_ports {enable[3]}]
set_property PACKAGE_PIN C1 [get_ports {enable[2]}]
...
set_property PACKAGE_PIN G2 [get_ports {enable[0]}]
set_property PACKAGE_PIN C2 [get_ports {enable[1]}]
